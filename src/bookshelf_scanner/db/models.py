...
class LibraryMembership(TimestampMixin, db.Model):
    ...
    __table_args__ = (
        UniqueConstraint(
            "follower_user_id",
            "followed_user_id",
            name="uq_library_memberships_follower_followed",
        ),
        CheckConstraint(
            "follower_user_id <> followed_user_id",
            name="ck_library_memberships_not_self",
        ),
        CheckConstraint(
            "status IN ('active', 'blocked')",
            name="ck_library_memberships_status",
        ),
    )
