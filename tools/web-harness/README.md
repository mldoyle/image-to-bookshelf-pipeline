...
```bash
cd /Users/mattdoyle/Projects/image-to-bookshelf/tools/web-harness
npm install
npm run dev
```
...
bookshelf-backend-api --host localhost --port 5000
```
...
```bash
bookshelf-backend-api --host 0.0.0.0 --port 5000
```
