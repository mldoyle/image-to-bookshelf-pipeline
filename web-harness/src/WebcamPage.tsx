...
export function WebcamPage() {
  ...
  const processFrame = useCallback(async () => {
    ...
    try {
      ...
      const readyUpdate = readyMachineRef.current.updateFromCandidates(
        detections.frameTimestampMs,
      ...
      setDebugView((previous) => ({
        ...
        reasons: best?.quality.reasons ?? readyUpdate.reasons,
      ...
      <section className="capture-strip">
        <article className="card">
          ...
          {latestCaptureDataUrl ? (
            ...
            <p className="muted">
              Waiting for a ready rising-edge trigger to capture a frame.
            </p>
          )}
        </article>
      </section>
