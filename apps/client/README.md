...
```bash
cd /Users/mattdoyle/Projects/image-to-bookshelf/apps/client
npm install
npm run start
```
...
- `@bookshelf/scanner-core` is reused from `../../tools/scanner-core/src` via Metro + TypeScript aliases.
...
Generated icon components are written to `apps/client/src/icons`.
